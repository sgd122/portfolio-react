      ...
      <div className="page-6">
        ...
        <div className="container-fluid">
          <div className="page-6-content">
            ...
            <p><span className="fa fa-envelope" aria-hidden="true"></span> <a className="email" href="mailto:dirrksdl@naver.com"> dirrksdl@naver.com</a></p>
            <p className="more-contact"> 이메일로 연락주시면 상세한 이력서 보내드리겠습니다.<br /> 당신과 함께 성장하고 싶습니다.</p>
            <p><a className="btn btn-dark btn-sm" href="https://drive.google.com/open?id=1GC2ia6sND-vwEIl7hn_iSm0KNoV-gcDV" role="button" target="_blank">
